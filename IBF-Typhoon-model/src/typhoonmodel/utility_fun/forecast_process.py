...
class Forecast:
    def __init__(self, main_path, remote_dir, typhoonname, offlinedata, admin_level, countryCodeISO3):
        ...
        self.pcode=pd.read_csv(os.path.join(self.main_path,"data/pre_disaster_indicators/pcode.csv"))
        ...
        if not typhoonname:
            ...
            if not Activetyphoon:
                ...
                process_typhoon = False
        else:
            Activetyphoon = [typhoonname]
            process_typhoon = True # or False
